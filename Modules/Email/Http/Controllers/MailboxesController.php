...
class MailboxesController extends Controller
{
    ...
    {
        /*
        'email_address', 'email_name', 'department_id', 'priority_id', 'helptopic_id', 'mailbox_protocol',
        'user_name', 'password', 'fetching_status', 'fetching_host', 'fetching_port', 'fetching_protocol', 'fetching_encryption',
        ...
        /*
        {data: 'mailboxlink', name: 'name'},
        {data: 'emailaddress', name: 'email'},
        {data: 'department', name: 'work_number'},
         **/
