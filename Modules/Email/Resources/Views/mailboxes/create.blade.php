...
@section('Mailboxes')
    ...
    @stop
            <!-- header -->
@section('PageHeader')
    <h1>{{Lang::get('emails::lang.add_a_mailbox')}}</h1>
    @stop
            <!-- /header -->
    <!-- breadcrumbs -->
@section('breadcrumbs')
...
<!-- open a form -->
    <form id="form">
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-xs-4 form-group"
                        ...
                        {!! Form::label('email_address',Lang::get('emails::lang.email_address')) !!}
                        {!! Form::text('email_address',null,['class' => 'form-control', 'id' => 'email_address']) !!}
                    </div>
                    <!-- Email name -->
                    <div class="col-xs-4 form-group"
                         id="email_name_error">
                        {!! Form::label('email_name',Lang::get('emails::lang.from_name')) !!}
                        {!! Form::text('email_name',null,['class' => 'form-control', 'id' => 'email_name']) !!}
                    </div>
                    <!-- password -->
                    <div class="col-xs-4 form-group"
                         id="password_error">
                        {!! Form::label('password',Lang::get('emails::lang.password')) !!}
                        {!! Form::password('password',['class' => 'form-control', 'id' => 'password']) !!}
                    </div>
                </div>
            </div>
            <div class="box-header with-border">
                <h3 class="box-title">{!! Lang::get('emails::lang.incoming_email_information') !!}</h3>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-xs-1 form-group">
                            {!! Form::label('fetching_status',Lang::get('emails::lang.status')) !!}
                        </div>
                        <div class="col-xs-2 form-group">
                            <!--{!! Form::radio('fetching_status','1',true) !!} {{Lang::get('emails::lang.enable')}}-->
                            <input type="checkbox" checked='checked' name="fetching_status"
                                   id="fetching_status"> {{Lang::get('emails::lang.enable')}}
                        </div>
                        <div class="col-xs-2 form-group">
                            <!--<input type="radio" name="fetching_status" id="fetching_status" value="0"> {{Lang::get('emails::lang.disabled')}}-->
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-2 form-group"
                        ...
                        {!! Form::label('fetching_protocol',Lang::get('emails::lang.fetching_protocol')) !!}
            ...
            <div class="box-header with-border">
                <h3 class="box-title">{!! Lang::get('emails::lang.outgoing_email_information') !!}</h3>
            </div>
            <div class="box-body">
                <div class="row">
                    <!-- status -->
                    <div class="form-group">
                        <div class="col-xs-1 form-group">
                            {!! Form::label('sending_status',Lang::get('emails::lang.status')) !!}
                        </div>
                        <div class="col-xs-2 form-group">
                            <input type="checkbox" name="sending_status"
                                   id="sending_status"> {!! Lang::get('emails::lang.enable') !!}
                        </div>
                        <div class="col-xs-2 form-group">
                            <!--<input type="radio" name="sending_status" id="sending_status" value=""> {!! Lang::get('emails::lang.disabled') !!}-->
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-xs-3 form-group"
                        ...
                        {!! Form::label('sending_protocol',Lang::get('emails::lang.transfer_protocol')) !!}
                        {!!Form::select('sending_protocol',['smtp'=>'SMTP'],null,['class' => 'form-control select']) !!}
                    </div>
                    <!-- sending hoost -->
                    <div class="col-xs-3 form-group"
                         id="sending_host_error">
                        {!! Form::label('sending_host',Lang::get('emails::lang.host_name')) !!}
                        {!! Form::text('sending_host',null,['class' => 'form-control']) !!}
                    </div>
                    <!-- sending port -->
                    <div class="col-xs-3 form-group"
                         id="sending_port_error">
                        {!! Form::label('sending_port',Lang::get('emails::lang.port_number')) !!}
                        {!! Form::text('sending_port',null,['class' => 'form-control']) !!}
                    </div>
                    <!-- Encryption -->
                    <div class="col-xs-3 form-group"
                         id="sending_encryption_error">
                        {!! Form::label('sending_encryption',Lang::get('emails::lang.encryption')) !!}
