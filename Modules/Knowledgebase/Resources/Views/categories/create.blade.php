...
@section('content')
    {!! Form::open([
            'route' => 'kbcategories.store',
            'method' => 'post'
        ]) !!}
    <div class="box box-primary">
        <div class="box-header">
            <h4 class="box-title">{!! Lang::get('knowledgebase::lang.addcategory') !!}</h4> {!! Form::submit(Lang::get('knowledgebase::lang.save'),['class'=>'form-group btn btn-primary pull-right'])!!}
        </div>
        <div class="box-body">
            @if(Session::has('success'))
                ...
                <div class="row">
                    ...
                    <div class="col-xs-3 form-group {{ $errors->has('parent') ? 'has-error' : '' }}">
                        ...
                        {!!Form::select('parent',[''=>'Select a Group','Categorys'=> null],null,['class' => 'form-control select']) !!}
                    ...
                    <div class="col-md-12 form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                        ...
                        {!! Form::textarea('description',null,['class' => 'form-control','id'=>'description','placeholder'=>Lang::get('knowledgebase::lang.enter_the_description') ]) !!}
