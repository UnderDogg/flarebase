...
<div class="site-hero clearfix">
    <ol class="breadcrumb breadcrumb-custom">
        ...
        <li><a href="{{url('/')}}">{!! Lang::get('knowledgebase::lang.home') !!}</a></li>
        <li><a href="{{url('/knowledgebase')}}">{!! Lang::get('knowledgebase::lang.knowledge_base') !!}</a></li>
...
<div id="content" class="site-content col-md-9">
    ...
    <div id="comments" class="comments-area">
        ...
        <div id="respond" class="comment-respond form-border">
            <h3 id="reply-title" class="comment-reply-title section-title">{!! Lang::get('knowledgebase::lang.leave_a_reply') !!}</h3>
                ...
                <div class="form-group">
                    <div class="col-md-4">
                        ...
                        <div class="form-group {{ $errors->has('website') ? 'has-error' : '' }}">
                            {!! Form::label('website',Lang::get('knowledgebase::lang.website')) !!}
                            {!! $errors->first('website', '<spam class="help-block">:message</spam>') !!}
                            {!! Form::text('website',null,['class' => 'form-control']) !!}
                        </div>
                        <button type="submit" class="btn btn-custom btn-lg">{!! Lang::get('knowledgebase::lang.post_message') !!}</button>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group {{ $errors->has('comment') ? 'has-   error' : '' }}">
                            {!! Form::label('comment',Lang::get('knowledgebase::lang.message')) !!}
