                            ...
                            <li class="dropdown user user-menu">
                                ...
                                @endif          
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="{{url('profile')}}" class="btn btn-default btn-flat">{{Lang::get('knowledgebase::lang.profile')}}</a>
                                        </div>
                                        <div class="pull-right">
                                            <a href="{{ url('/auth/logout') }}" class="btn btn-default btn-flat">{{Lang::get('knowledgebase::lang.signout')}}</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <a href="#">
                                ...
                                <i class="fa fa-angle-left pull-right"></i>
                                    ...
                                    <ul class="treeview-menu">
                                        <li @yield('add-category')><a href="{{url('category/create')}}"><i class="fa fa-circle-o"></i> {{Lang::get('knowledgebase::lang.addcategory')}}</a></li>
                                         <li @yield('all-category')><a href="{{url('category')}}"><i class="fa fa-circle-o"></i> {{Lang::get('knowledgebase::lang.allcategory')}}</a></li>
                                     </ul>
                        </li>
                        <li class="treeview @yield('article')">
                            <a href="#">
                                ...
                                <i class="fa fa-angle-left pull-right"></i>
                                    ...
                                    <ul class="treeview-menu">
                                        <li @yield('add-article')><a href="{{url('article/create')}}"><i class="fa fa-circle-o"></i> {{Lang::get('knowledgebase::lang.addarticle')}}</a></li>
                                         <li @yield('all-article')><a href="{{url('article')}}"><i class="fa fa-circle-o"></i> {{Lang::get('knowledgebase::lang.allarticle')}}</a></li>
                                     </ul>
                        </li>
                        ...
                        <li class="treeview @yield('pages')">
                            <a href="#">
                                ...
                                <i class="fa fa-angle-left pull-right"></i>
                                    ...
                                    <ul class="treeview-menu">
                                        <li @yield('add-pages')><a href="{{url('page/create')}}"><i class="fa fa-circle-o"></i> {{Lang::get('knowledgebase::lang.addpages')}}</a></li>
                                         <li @yield('all-pages')><a href="{{url('page')}}"><i class="fa fa-circle-o"></i> {{Lang::get('knowledgebase::lang.allpages')}}</a></li>
                                     </ul>
                        </li>
                        <li class="treeview @yield('widget')">
                            <a href="#">
                                <i class="fa  fa-th"></i> <span>{{Lang::get('knowledgebase::lang.widgets')}}</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                                    <ul class="treeview-menu">
                                        <li @yield('footer1')><a href="{{url('create-footer')}}"><i class="fa fa-circle-o"></i> {{Lang::get('knowledgebase::lang.footer1')}}</a></li>
                                        <li @yield('footer2')><a href="{{url('create-footer2')}}"><i class="fa fa-circle-o"></i> {{Lang::get('knowledgebase::lang.footer2')}}</a></li>
                                        <li @yield('footer3')><a href="{{url('create-footer3')}}"><i class="fa fa-circle-o"></i> {{Lang::get('knowledgebase::lang.footer3')}}</a></li>
                                        <li @yield('footer4')><a href="{{url('create-footer4')}}"><i class="fa fa-circle-o"></i> {{Lang::get('knowledgebase::lang.footer4')}}</a></li>
                                        <li @yield('side1')><a href="{{url('side1')}}"><i class="fa fa-circle-o"></i> {{Lang::get('knowledgebase::lang.sidewidget1')}}</a></li>
                                        <li @yield('side2')><a href="{{url('side2')}}"><i class="fa fa-circle-o"></i> {{Lang::get('knowledgebase::lang.sidewidget2')}}</a></li>
