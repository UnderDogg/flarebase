...
class CategoryController extends Controller
{
  ...
  public function index()
  {
    /*  get the view of index of the catogories with all attributes
      of category model */
    try {
      return view('knowledgebase::staff.kb.category.index');
    } catch (Exception $e) {
  ...
  public function getData()
  {
    ...
    return Datatable::collection(Category::All())
      ...
      ->addColumn('Actions', function ($model) {
        return '<span  data-toggle="modal" data-target="#deletecategory' . $model->slug . '"><a href="#" ><button class="btn btn-danger btn-xs"></a>' . \Lang::get('knowledgebase::lang.delete') . '</button></span>&nbsp;<a href=category/' . $model->id . '/edit class="btn btn-warning btn-xs">' . \Lang::get('knowledgebase::lang.edit') . '</a>&nbsp;<a href=article-list class="btn btn-primary btn-xs">' . \Lang::get('knowledgebase::lang.view') . '</a>
  ...
  public function create(Category $category)
  {
    ...
    /* get the view page to create new category with all attributes
      of category model */
    try {
      return view('knowledgebase::staff.kb.category.create', compact('category'));
    } catch (Exception $e) {
      return redirect()->back()->with('fails', $e->errorInfo[2]);
    }
  }
  ...
  public function edit($slug, Category $category)
  {
    ...
    return view('knowledgebase::staff.kb.category.edit', compact('category'));
  }
