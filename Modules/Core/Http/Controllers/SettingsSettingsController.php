...
// requests
use Modules\Core\Requests\CompanyRequest;
use Modules\Core\Requests\EmailRequest;
use Modules\Core\Requests\SystemRequest;
// models
...
use Modules\Core\Models\Settings\Access;
use Modules\Core\Models\Settings\Alert;
use Modules\Core\Models\Settings\Company;
use Modules\Core\Models\Settings\Email;
use Modules\Core\Models\Settings\Responder;
...
use Modules\Core\Models\Utility\Date_time_format;
use Modules\Core\Models\Utility\Time_format;
...
class SettingsController extends Controller
{
    ...
    public function getcompany(Company $company)
    {
        try {
            ...
            return view('core::settings.company', compact('companys'));
        } catch (Exception $e) {
...
//	// 		 Direct to Access Settings Page
    // 		return view('core::settings.access', compact('accesses'));
    // 	} catch (Exception $e) {
    ...
    public function RatingSettings()
    {
        ...
        return view('core::settings.ratings', compact('ratings'));
    }
