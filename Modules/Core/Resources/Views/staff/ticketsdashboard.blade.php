...
{{-- <script src="{{asset("lb-faveo/dist/js/bootstrap-datetimepicker4.7.14.min.js")}}" type="text/javascript"></script> --}}
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">{!! Lang::get('core::lang.line_chart') !!}</h3>
...
<div id="legendDiv"></div>
            ...
            <div class="box">
                <div class="box-header">
                             <h1>{!! Lang::get('core::lang.statistics') !!}</h1>
              ...
              <table class="table table-hover" style="overflow:hidden;">
                ...
                <tr>
                <th>{!! Lang::get('core::lang.department') !!}</th>
                <th>{!! Lang::get('core::lang.opened') !!}</th>
                <th>{!! Lang::get('core::lang.resolved') !!}</th>
                <th>{!! Lang::get('core::lang.closed') !!}</th>
