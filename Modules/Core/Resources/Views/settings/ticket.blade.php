	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-primary">
                ...
                <h3 class="box-title">{{Lang::get('core::lang.ticket')}}</h3> <div class="pull-right">
...
@if(Session::has('success'))
	...
	<!-- Default Ticket Number Format: text	 e.g. 268330 -->
		...
		<!-- <div class="form-group {{ $errors->has('num_format') ? 'has-error' : '' }}"> -->
			...
			{{-- {!! Form::label('num_format',Lang::get('core::lang.default_ticket_number_format')) !!} --}}
	...
	<!-- Default Ticket Number Sequence: dropdown : manual	   Manage -->
			...
			{{-- {!! Form::label('num_sequence',Lang::get('core::lang.default_ticket_number_sequence')) !!} --}}
	...
	<!-- Default Status: Required : manual: Dropdowm  -->
		...
		<div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
			{!! Form::label('status',Lang::get('core::lang.default_status')) !!}
	...
	<!-- Default Priority:	Required : manual : Dropdowm  -->
		...
		<div class="form-group {{ $errors->has('priority') ? 'has-error' : '' }}">
			{!! Form::label('priority',Lang::get('core::lang.default_priority')) !!}
	...
	<!-- Default SLA:	Required : manual : Dropdowm  -->
       <div class="col-md-2">
		<div class="form-group {{ $errors->has('sla') ? 'has-error' : '' }}">
			{!! Form::label('sla',Lang::get('core::lang.default_sla')) !!}
	...
	<!-- Default Help Topic:  Dropdowm from Help topic table	 -->
            <div class="col-md-2">
		        <div class="form-group {{ $errors->has('help_topic') ? 'has-error' : '' }}">
			        {!! Form::label('help_topic',Lang::get('core::lang.default_help_topic')) !!}
	...
	<!-- Maximum Open Tickets: text-number	 per end user  -->
            {{-- <div class="col-md-6"> --}}
		        {{-- <div class="form-group {{ $errors->has('max_open_ticket') ? 'has-error' : '' }}"> --}}
			      	{{-- {!! Form::label('max_open_ticket',Lang::get('core::lang.maximum_open_tickets')) !!} --}}
	...
	<!-- Agent Collision Avoidance Duration: text-number   -minutes  -->
          	<div class="col-md-3">
		        <div class="form-group {{ $errors->has('collision_avoid') ? 'has-error' : '' }}">
			        {!! Form::label('collision_avoid',Lang::get('core::lang.agent_collision_avoidance_duration')) !!}
			    	...
			    	<div class="input-group-addon">
                          <span><i class="fa fa-clock-o"></i> {!!Lang::get('core::lang.in_minutes')!!}</span>
                    </div>
                </div>
			    </div> 
		    </div> 
	...
	<!-- Human Verification: checkbox	 Enable CAPTCHA on new web tickets.      -->
            ...
            {{-- <div class="col-md-6"> --}}
		      	{{-- <div class="form-group"> --}}
		        	...
		        	{{-- {!! Form::label('captcha',Lang::get('core::lang.human_verification')) !!} --}}
				{{-- </div> --}}
	...
	<!-- Claim on Response:	 checkbox -->
				...
				{{-- <div class="form-group"> --}}
					...
					{{-- {!! Form::label('claim_response',Lang::get('core::lang.claim_on_response')) !!} --}}
				{{-- </div> --}}
	...
	<!-- Assigned Tickets:	checkbox- Exclude assigned tickets from open queue.  -->
				...
				{{-- <div class="form-group"> --}}
					...
					{{-- {!! Form::label('assigned_ticket',Lang::get('core::lang.assigned_tickets')) !!} --}}
				{{-- </div> --}}
	...
	<!-- Answered Tickets:	checkbox- Exclude answered tickets from open queue.  -->
				...
				{{-- <div class="form-group"> --}}
					...
					{{-- {!! Form::label('answered_ticket',Lang::get('core::lang.answered_tickets')) !!} --}}
				{{-- </div> --}}
	...
	<!-- Agent Identity Masking: checkbox-	 Hide agent's name on responses.  -->
				...
				{{-- <div class="form-group"> --}}
					...
					{{-- {!! Form::label('agent_mask',Lang::get('core::lang.agent_identity_masking')) !!} --}}
				{{-- </div> --}}
	...
	<!-- Enable HTML Ticket Thread:	 checkbox- Enable rich text in ticket thread and autoresponse emails.  -->
				...
				{{-- <div class="form-group"> --}}
					...
					{{-- {!! Form::label('html',Lang::get('core::lang.enable_HTML_ticket_thread')) !!} --}}
				{{-- </div> --}}
	...
	<!-- Allow Client Updates: checkbox -->
				...
				{{-- <div class="form-group"> --}}
					...
					{{-- {!! Form::label('client_update',Lang::get('core::lang.allow_client_updates')) !!} --}}
				{{-- </div> --}}
