...
<div class="box box-primary">
	<div class="content-header">
	 	...
	 	<h4>{{Lang::get('core::lang.add-lang-package')}}	{!! Form::submit(Lang::get('core::lang.save'),['class'=>'form-group btn btn-primary pull-right'])!!}</h4>
	...
	<div class="box-body">
		@if(Session::has('success'))
            ...
            <div class="alert alert-danger alert-dismissable">
                ...
                {{Session::get('fails')}}
                @if(Session::has('link'))
                	<a href="{{url(Session::get('link'))}}">{{Lang::get('core::lang.enable_lang')}}</a>
            	@endif
            	@if(Session::has('link2'))
            		<a href="{{url(Session::get('link2'))}}" target="blank">{{Lang::get('core::lang.read-more')}}</a>
            	@endif
            </div>
            @endif
	...
	<!-- username -->
		<div class="col-xs-4 form-group {{ $errors->has('language-name') ? 'has-error' : '' }}">
			...
			{!! Form::label('language-name',Lang::get('core::lang.language-name')) !!}
		...
		<div class="col-xs-4 form-group {{ $errors->has('iso-code') ? 'has-error' : '' }}">
			...
			{!! Form::label('iso-code',Lang::get('core::lang.iso-code')) !!}
	...
	<div class="row">
        <div class="col-xs-4 form-group {{ $errors->has('File') ? 'has-error' : '' }}">
			...
			{!! Form::label('File',Lang::get('core::lang.file')) !!}&nbsp
        	<div class="btn bg-olive btn-file" style="color:blue"> {!! Lang::get('core::lang.upload_file') !!}
			{!! Form::file('File') !!}
        	</div>
