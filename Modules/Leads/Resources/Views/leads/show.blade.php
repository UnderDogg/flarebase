        ...
        <div class="col-md-6">
            ...
            <div class="contactleft">
                ...
                <p><span class="glyphicon glyphicon-headphones" aria-hidden="true" data-toggle="tooltip"
                         ...
                         data-placement="left"> </span>
                    <a href="tel:{{$leads->relationAssignee->work_number}}">{{$leads->relationAssignee->primary_number}}</a>
                </p>
                @endif
        ...
        <div class="col-md-9">
            ...
            @foreach($leads->notes as $note)
                <div class="ticketcase" style="margin-top:15px; padding-top:10px;">
                    ...
                    <p>  {{$note->note}}</p>
                    <p class="smalltext">note by: <a
                                href="{{route('staff.show', $note->user->id)}}"> {{$note->user->name}} </a>
                    </p>
                    <p class="smalltext">Created at:
